  ...
  async getStats(): Promise<DashboardStats> {
    try {
      ...
      return {
        ...
        netProfit: 342000,
        totalDueBalance: 18500,
        recentSales: mockInvoices,
        salesChartData: [
          { date: "Mon", amount: 28500, orders: 22 },
          { date: "Tue", amount: 31200, orders: 25 },
          { date: "Wed", amount: 24800, orders: 19 },
          { date: "Thu", amount: 39500, orders: 31 },
          { date: "Fri", amount: 48900, orders: 42 },
          { date: "Sat", amount: 54100, orders: 48 },
          { date: "Sun", amount: 34250, orders: 28 },
        ],
      };
    }
  },
